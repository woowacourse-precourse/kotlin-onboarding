...
fun solution6(forms: List<List<String>>): List<String> {
    ...
    saveByTwoWords(forms, twoWordsArray)
    saveCountAndLength(forms, twoWordsArray, countArray, lengthArray)
    selectEmailOfDuplicatedNickname(countArray, lengthArray, result, forms)
