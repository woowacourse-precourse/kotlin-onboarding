...
private fun checkValidPage(leftPage: Int, rightPage: Int) = (leftPage%2 == 1 && rightPage%2 == 0)

private fun checkPairPage(leftPage: Int, rightPage: Int) = (rightPage - leftPage == 1)
