...
## ✅ 기능 목록
1. 예외사항 체크 함수
> - [x] 페이지 번호는 1 - 400 범위를 넘지 않는다.
> - [x] 시작 면이나 마지막 면이 나오도록 책을 펼치지 않는다.
> - [x] 왼쪽 페이지와 오른쪽 페이지의 값은 연속한 두 정수의 쌍이다.
> - [x] 왼쪽 페이지는 홀수, 오른쪽 페이지는 짝수 번호이다.
2. 자릿수의 합과 곱을 이용해 최대 숫자 구하는 함수
> - [x] 왼쪽 페이지 번호의 각 자리 숫자를 모두 더하거나, 모두 곱해 가장 큰 수를 구한다.
> - [x] 오른쪽 페이지 번호의 각 자리 숫자를 모두 더하거나, 모두 곱해 가장 큰 수를 구한다.
> - [x] 위에서 구한 두 수 중 더 큰 값을 점수로 한다.
3. 승자를 결정하는 메인 함수
> - [x] 두 사람의 점수를 비교해 게임의 승자를 결정한다.
